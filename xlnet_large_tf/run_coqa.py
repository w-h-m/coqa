...
from xlnet import prepro_utils,model_utils,xlnet
...
flags.DEFINE_integer("train_batch_size", default=16, help="Total batch size for training.")
flags.DEFINE_integer("predict_batch_size", default=16, help="Total batch size for predict.")
...
class CoqaPipeline(object):
    ...
    def get_dev_examples(self):
        ...
        data_path = os.path.join(self.data_dir, "dev-{0}.json".format(self.task_name))#路径拼接
        data_list = self._read_json(data_path)
        example_list = self._get_example(data_list)
        return example_list
